...
export class LegalComponent implements OnInit {
  ...
  readonly features = [
    ...
    { icon: '📄', title: 'Skaner CV', desc: 'Wgrane CV jest analizowane przez backend, który wyciąga z niego technologie i wstawia do filtrów. Sam plik nie jest przechowywany po zapisie profilu.' },
